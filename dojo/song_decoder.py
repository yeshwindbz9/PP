# -*- coding: utf-8 -*-
"""
Created on Wed Mar  3 17:41:42 2021
...
(that don't contain WUB). To make the dubstep remix of this song, Polycarpus 
inserts a certain number of words "WUB" before the first word of the song 
(the number may be zero), after the last word (the number may be zero), and 
...
def song_decoder(song):
    """ 
    Decodes "WUB" dupstepped songs. 
  
    Produces the original song that Polycarpus dupstepped using the word "WUB". 
  
    Parameters: 
    str: input dupstepped song 
  
    Returns: 
    str: output original song 
